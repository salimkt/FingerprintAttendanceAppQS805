	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myfpchar.setOnItemSelectedListener(new Spinner.OnItemSelectedListener(){
			public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				switch(arg2){
					case 0:
						fpcharlen = 512;fpchcount = 2;
						break;
					case 1:
						fpcharlen = 512;fpchcount = 2;
						break;
					case 2:
						fpcharlen = 768;fpchcount = 2;
						break;
					case 3:
						fpcharlen = 1536;fpchcount = 4;
						break;
					case 4:
						fpcharlen = 2304;fpchcount = 4;
						break;
				}
			}
		...
		greenOnReceiver = new GreenOnReceiver();

		IntentFilter filter = new IntentFilter();
		filter.addAction(Intent.ACTION_SCREEN_ON);
		filter.addAction(Intent.ACTION_SCREEN_OFF);
		filter.addAction(Intent.ACTION_USER_PRESENT);
		registerReceiver(greenOnReceiver, filter);

	}

	GreenOnReceiver greenOnReceiver;
	class GreenOnReceiver extends BroadcastReceiver {
		@Override
